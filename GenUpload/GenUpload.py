...
print("Upload filenames generator")

if len(sys.argv) != 4:
    print(f"Usage : {sys.argv[0]} <list|gen> <best|all> <filename> <extension (gif,jpg,png)>")
    exit()


mode = "gen" if sys.argv[1] == "gen" else "list"
extended = "all" if sys.argv[1] == "all" else "best"
